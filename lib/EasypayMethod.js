 ...
 */
module.exports = function easypayMethod(spec) {
        ...
        return this.wrapTimeout(new Promise((function (resolve, reject) {
            for (var i = 0, l = urlParams.length; i < l; ++i) {
                ...
                if (!arg) {
                    ...
                    err = new Error('Easypay: I require argument "' + urlParams[i] + '", but I got: ' + arg);
                    reject(err);
                    return;
                }
            ...
            if (args.length) {
                err = new Error(
                    'Easypay: Unknown arguments (' + args + '). Did you mean to pass an options object?'
                );
                reject(err);
                return;
            }
